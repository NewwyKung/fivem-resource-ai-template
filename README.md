...
> **Status:** Public Preview (`0.3.0`). Static repository checks and release tooling are automated. FiveM natives, lifecycle behavior, disconnect handling, integrations, and NUI focus still require verification on a real FXServer.
